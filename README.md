...
Through visualizations such as charts, maps, and KPI indicators, the dashboard highlights pollution trends, AQI categories, and pollutant impacts. This makes it easier for analysts, researchers, and policymakers to monitor environmental conditions and take informed decisions.

So, the story behind this project is to use data analytics and visualization to raise awareness about air pollution and help people understand air quality patterns through an interactive Power BI dashboard.🌍📊
...
📐 DAX (Data Analysis Expressions) – Creating calculations and measures

📑 Microsoft Excel – Data storage and dataset source
